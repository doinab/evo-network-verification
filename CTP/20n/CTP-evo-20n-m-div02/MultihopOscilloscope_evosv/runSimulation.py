...
noise = open("noise/meyer-short.txt", "r")
...
#t.addChannel("ENERGY_HANDLER", sys.stdout) # <- this line gave simlog01.txt
#t.addChannel("TreeRouting", sys.stdout)    # <- this line gave simlog00.txt
t.addChannel("Gain", sys.stdout)            # <- this line gave simlog02.txt
